...
build:
	...
	ln -s ../Frameworks/XUL.framework/Versions/Current/xulrunner $(BUILD)/MacOS/xulrunner
	...
	cp $(SRC)/Resources/chrome/content/uploadr/*.* $(BUILD)/Resources/chrome/content/uploadr/
	mkdir $(BUILD)/Resources/chrome/locale
	mkdir $(BUILD)/Resources/chrome/locale/branding
	cp $(SRC)/Resources/chrome/locale/branding/*.* $(BUILD)/Resources/chrome/locale/branding/
	mkdir $(BUILD)/Resources/chrome/locale/en-US
	cp $(SRC)/Resources/chrome/locale/en-US/*.* $(BUILD)/Resources/chrome/locale/en-US/
	mkdir $(BUILD)/Resources/chrome/skin
	mkdir $(BUILD)/Resources/chrome/skin/hacks
	mkdir $(BUILD)/Resources/chrome/skin/hacks/mac
	cp $(SRC)/Resources/chrome/skin/hacks/mac/hacks.css $(BUILD)/Resources/chrome/skin/hacks/mac/
	mkdir $(BUILD)/Resources/chrome/skin/hacks/win
	cp $(SRC)/Resources/chrome/skin/hacks/win/hacks.css $(BUILD)/Resources/chrome/skin/hacks/win/
	mkdir $(BUILD)/Resources/chrome/skin/hacks/unix
	cp $(SRC)/Resources/chrome/skin/hacks/unix/hacks.css $(BUILD)/Resources/chrome/skin/hacks/unix/
	mkdir $(BUILD)/Resources/chrome/skin/uploadr
	cp $(SRC)/Resources/chrome/skin/uploadr/*.css $(BUILD)/Resources/chrome/skin/uploadr/
